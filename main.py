...
EQB2A.train_knockoff(Tr_I, Tr_T, Tr_L) # EQB2A.train_knockoff(Te_I, Te_T, Te_L, Db_I, Db_T, Db_L) # EQB2A.train_knockoff(Tr_I, Tr_T, Tr_L, Db_I, Db_T, Db_L)
EQB2A.test_knockoff(Te_I, Te_T, Te_L, Db_I, Db_T, Db_L)
EQB2A.train_perturbation_model(Tr_I, Tr_T, Tr_L) # EQB2A.train_perturbation_model(Te_I, Te_T, Te_L, Db_I, Db_T, Db_L) # EQB2A.train_perturbation_model(Tr_I, Tr_T, Tr_L, Db_I, Db_T, Db_L)
EQB2A.test_perturbation_model(Te_I, Te_T, Te_L, Db_I, Db_T, Db_L)
EQB2A.train_attack_model(Tr_I, Tr_T, Tr_L) # EQB2A.train_attack_model(Te_I, Te_T, Te_L, Db_I, Db_T, Db_L) # EQB2A.train_attack_model(Tr_I, Tr_T, Tr_L, Db_I, Db_T, Db_L)
